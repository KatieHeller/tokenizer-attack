...
corpus_dir = Path('/scratch/network/kh3329/tokenizer-attack/oscar-mini')
clean_dir = corpus_dir / 'processed'

os.environ["HF_DATASETS_CACHE"] = str(corpus_dir / 'hf_cache')

language_codes = get_dataset_config_names('nthngdy/oscar-mini')
...
for language_code in language_codes:
    try:
        ...
        output_file = output_dir / f'{language_code}_oscar_mini.txt'
